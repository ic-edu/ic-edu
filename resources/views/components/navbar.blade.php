<style>
    ...
    .test-doc {
        ...
        border-radius: 14px; padding: 14px 16px 20px; width: 120px;
    ...
    .test-doc-line  { height: 7px; border-radius: 99px; background: #e8edf4; margin-bottom: 7px; }
    .test-doc-dot   { width: 10px; height: 10px; border-radius: 50%; background: #e8edf4; display: inline-block; margin-right: 6px; flex-shrink: 0; }

    .test-card:hover .test-doc,
    .test-card.active .test-doc { transform: rotate(-4deg) translateY(-6px); box-shadow: 0 16px 40px rgba(0,0,0,.14); }
    .test-card:hover .test-doc-back,
    .test-card.active .test-doc-back { transform: rotate(5deg) translateY(-2px); }
    .test-card.active .test-doc-label { color: inherit; }
    .test-card.active .test-doc       { border-color: transparent; }

    #tests-dropdown { transform-origin: top center; }
    #tests-dropdown.open {
        opacity: 1 !important; visibility: visible !important;
        transform: translateY(0) !important; pointer-events: auto !important;
    }

    .nav-pill { position: relative; padding-bottom: 2px; }
    .nav-pill::after {
        content: ''; position: absolute; bottom: -2px; left: 0; right: 0;
        height: 2px; border-radius: 99px; background: #2563eb;
