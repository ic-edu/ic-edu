...
@section('content')
    ...
    {{-- ═══════════════════════════════════════
         HERO
    ════════════════════════════════════════ --}}
    <section class="min-h-screen pt-24 pb-12 px-[5%] relative overflow-hidden flex items-center"
        ...
        <div class="max-w-[1160px] mx-auto w-full grid lg:grid-cols-[1fr_480px] gap-10 items-center relative z-10">
            ...
            <div data-reveal>
                ...
                <p class="text-base text-slate-500 leading-[1.8] mb-8 max-w-[480px]">
                    IC.EDU is your all-in-one English learning platform — built for Indonesians who want to ace IELTS, TOEFL, TOEIC, or simply speak English with confidence in the real world.
                </p>

                <div class="flex flex-wrap gap-3 mb-10">
                    <a href="{{ route('register') }}"
                       class="inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-sm font-bold text-white bg-blue-600 shadow-lg shadow-blue-300/50 hover:bg-blue-700 hover:-translate-y-0.5 transition-all">
                        Start Learning Free
                    ...
                    <a href="#courses"
                       class="inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-sm font-bold text-slate-700 bg-white border border-slate-200 hover:border-blue-400 hover:text-blue-600 shadow-sm transition-all">
                        Browse Courses
                    </a>
                </div>
            ...
            <div class="hidden lg:block" data-reveal>
                <div class="relative pt-6 pb-16 pr-6 pl-10">
                    ...
                    {{-- "Did you know?" card --}}
                    <div class="absolute bottom-4 -left-2 w-[265px] bg-white rounded-2xl shadow-2xl shadow-slate-200/80 p-4 border border-slate-100 z-20">
                        ...
                        <p class="text-[0.76rem] text-slate-500 leading-[1.7]">
                            IC.EDU is not just a course platform — it's your personal English coach. AI-powered feedback, live sessions, and certified instructors to turn your goals into results.
                        </p>
                        <div class="flex flex-wrap gap-1.5 mt-3">
                            @foreach(['IELTS', 'TOEFL', 'TOEIC', 'Speaking', 'Writing','Listening','Grammar'] as $pill)
                                <span class="topic-pill text-[0.65rem] font-bold text-slate-600 bg-slate-100 px-2.5 py-1 rounded-full cursor-default">{{ $pill }}</span>
                            @endforeach
                        </div>
                    </div>
    ...
    <section class="py-24 px-[5%]" id="why">
        <div class="max-w-[1160px] mx-auto">
            ...
            <div class="text-center max-w-xl mx-auto mb-14" data-reveal>
                <span class="inline-block bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">Why Choose Us</span>
                <h2 class="text-3xl lg:text-4xl font-extrabold tracking-tight leading-[1.15] mb-3">Smart Learning, Real Results</h2>
                <p class="text-slate-500 leading-7">We make learning effective, enjoyable, and personalized — so you stay motivated and actually finish what you start.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                @foreach([
                    ...
                    <div class="bg-[#f8faff] border border-slate-200 rounded-[20px] p-7 hover:bg-white hover:shadow-xl hover:shadow-blue-100 hover:-translate-y-1 hover:border-blue-100 transition-all cursor-default" data-reveal>
                        <div class="w-[52px] h-[52px] rounded-[14px] flex items-center justify-center text-2xl mb-4" style="background: {{ $bg }};">{{ $icon }}</div>
    ...
    {{-- ═══════════════════════════════════════
         MARQUEE
    ════════════════════════════════════════ --}}
    <div class="overflow-hidden py-5 bg-blue-50 border-y border-blue-100">
        <div class="marquee-track flex gap-10 w-max">
            @php
                $marqueeItems = ['IELTS Preparation','TOEFL Training','Academic Writing','Public Speaking','Grammar Mastery','Vocabulary Builder','Listening Skills','Pronunciation','Business English','TOEIC Prep','Reading Skills','Daily Conversation'];
            @endphp
    ...
    {{-- ═══════════════════════════════════════COURSE CATEGORIES════════════════════════════════════════ --}}
    <section class="py-24 px-[5%] bg-[#f8faff]" id="courses">
        <div class="max-w-[1160px] mx-auto">

            <div class="text-center max-w-xl mx-auto mb-14" data-reveal>
                <span class="inline-block bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">Course Categories</span>
                <h2 class="text-3xl lg:text-4xl font-extrabold tracking-tight leading-[1.15] mb-3">Every Skill You Need to Speak with Confidence</h2>
                <p class="text-slate-500 leading-7">Structured, expert-led courses designed for real-world English — not just exams.</p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                @foreach($courseCards as $card)
                    <div class="bg-white border border-slate-200 rounded-[20px] overflow-hidden hover:-translate-y-1.5 hover:shadow-xl hover:shadow-blue-100 hover:border-blue-100 transition-all cursor-pointer group" data-reveal>
                        ...
                        <div class="relative overflow-hidden flex items-end justify-center px-6 pt-6 pb-0"
                            ...
                            {{-- Deco blob --}}
                            <div class="absolute w-28 h-28 rounded-full opacity-20 -right-4 -top-4 transition-transform duration-500 group-hover:scale-125"
                        ...
                        <div class="p-5">
                            <span class="inline-block text-[0.68rem] font-bold uppercase tracking-wide px-2.5 py-1 rounded-full mb-2"
                                  style="background: {{ $card['badgeBg'] }}; color: {{ $card['accent'] }};">{{ $card['badge'] }}</span>
            ...
            <div class="text-center mt-10" data-reveal>
                <a href="{{ route('course.index') }}"
                   class="inline-flex items-center gap-2 px-8 py-3.5 rounded-full text-sm font-bold text-white bg-blue-600 shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 transition-all">
                    View All Courses
                    <svg width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"/></svg>
                </a>
            </div>
    ...
    <section class="py-24 px-[5%]">
        <div class="max-w-[1160px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-reveal>
                <span class="inline-block bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">Built to Keep You Going</span>
                <h2 class="text-3xl lg:text-[2.2rem] font-extrabold tracking-tight leading-[1.2] mb-4">Stay consistent with tools that actually work</h2>
                <p class="text-sm text-slate-500 leading-7 mb-6">Stay consistent with gamified streaks, progress tracking, peer groups, and notifications that motivate — not annoy.</p>
                ...
                <a href="{{ route('register') }}"
                   class="inline-flex items-center gap-2 px-7 py-3.5 rounded-full text-sm font-bold text-white bg-blue-600 shadow-lg shadow-blue-200 hover:bg-blue-700 hover:-translate-y-0.5 transition-all">
                    Start Learning Free
                </a>
            </div>
    ...
    {{-- ═══════════════════════════════════════
         HOW IT WORKS
    ════════════════════════════════════════ --}}
    <section class="py-24 px-[5%] bg-gradient-to-br from-[#f0f7ff] to-[#e8f0fe]" id="how">
        <div class="max-w-[1160px] mx-auto">

            <div class="text-center max-w-xl mx-auto mb-14" data-reveal>
                <span class="inline-block bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">The Process</span>
                <h2 class="text-3xl lg:text-4xl font-extrabold tracking-tight leading-[1.15] mb-3">Simple Steps to English Fluency</h2>
                <p class="text-slate-500 leading-7">From zero to confident speaker — our proven 3-step path gets you there faster than you think.</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
                ...
                @foreach([
                    ...
                    <div class="bg-white rounded-3xl p-8 text-center border border-blue-100 shadow-sm hover:-translate-y-1.5 hover:shadow-xl hover:shadow-blue-100 transition-all relative z-[1]" data-reveal>
                        <div class="w-14 h-14 rounded-full bg-blue-600 text-white text-xl font-extrabold flex items-center justify-center mx-auto mb-5 shadow-md shadow-blue-300">
                            {{ $num }}
                        </div>
    ...
    <section class="py-24 px-[5%]">
        <div class="max-w-[1160px] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div data-reveal>
                <span class="inline-block bg-blue-50 text-blue-600 text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">You're Not Learning Alone</span>
                <h2 class="text-3xl lg:text-[2.2rem] font-extrabold tracking-tight leading-[1.2] mb-4">Join a community of learners from across the world</h2>
                <p class="text-sm text-slate-500 leading-7 mb-6">At IC.EDU, learning means more than just watching lessons — it's about growing together. Our vibrant community connects learners from around the world so you can discuss topics, share progress, and find the accountability partner you need.</p>
                <ul class="flex flex-col gap-2.5 mb-7">
    ...
    {{-- ═══════════════════════════════════════
         TESTIMONIALS
    ════════════════════════════════════════ --}}
    <section class="py-24 overflow-hidden" id="testimonials"
    ...
    <section class="py-20 px-[5%]">
        <div class="max-w-[1160px] mx-auto bg-gradient-to-br from-blue-800 via-blue-600 to-indigo-600 rounded-[32px] p-16 grid grid-cols-1 lg:grid-cols-[1fr_auto] gap-8 items-center relative overflow-hidden" data-reveal>
            ...
            <div class="relative z-10">
                ...
                <p class="text-sm text-white/75 leading-7 max-w-lg">
                    Join over 12,000 students who are already on their path to English fluency. Your first 7 days are completely free — no credit card required.
                </p>
            </div>

            <div class="flex flex-col gap-3 flex-shrink-0 relative z-10">
                <a href="{{ route('register') }}"
                   class="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-full text-sm font-bold text-blue-600 bg-white shadow-md hover:-translate-y-0.5 hover:shadow-lg transition-all">
